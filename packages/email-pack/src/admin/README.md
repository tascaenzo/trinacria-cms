...
values such as `email-pack:delivery-status-widget` and
`email-pack:email-template-manager`. The concrete React components live here and
are exported through `EMAIL_PACK_ADMIN_RENDERERS`.
