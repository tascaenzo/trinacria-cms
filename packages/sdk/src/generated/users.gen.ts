...
import type { CreateUserRequest, CreateUserResponse, GetUserByIdRequest, GetUserByIdResponse, InviteUserRequest, InviteUserResponse, ListUsersRequest, ListUsersResponse, UpdateUserProfileRequest, UpdateUserProfileResponse, UpdateUserStatusRequest, UpdateUserStatusResponse } from "./types.gen.js";
...
export function createUsersApi(client: CmsSdkClientCore): UsersApi {
  return {
    ...
    inviteUser: async (input, options) =>
      client.request({
        method: "POST",
