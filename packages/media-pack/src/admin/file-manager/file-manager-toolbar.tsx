  ...
  return (
    <header className="flex min-h-16 flex-wrap items-center justify-between gap-3 border-b border-[color:var(--color-border)] bg-[color:var(--color-surface)] px-4 py-3">
      <div className="flex flex-wrap items-center gap-2">
        ...
        <Button type="button" variant="secondary" disabled={isSaving} onClick={onCreateCsv}>
          <Icon name="file-plus-2" className="h-4 w-4" /> Nuovo CSV
        </Button>
        ...
        <Select
          ...
          value={sort}
          onChange={(event) => onSortChange(event.currentTarget.value as FileManagerSort)}
          className="w-36"
        >
