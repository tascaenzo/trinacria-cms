...
const meta = { title: "Display/Data/SummaryGrid", component: SummaryGrid } satisfies Meta<
  typeof SummaryGrid
>;
export default meta;
  ...
  render: () => (
    <SummaryGrid>
      ...
      <SummaryCard
        label="System state"
        value="Healthy"
        badge={<Badge tone="success">Success</Badge>}
      />
      <SummaryCard
        label="Admin model"
        value="Kernel-first"
        description="Shell e policy centralizzate"
      />
    </SummaryGrid>
  )
};
