...
export const SETTINGS_VALUES_REPOSITORY_TOKEN =
  createToken<SettingsValuesRepository>("CORE_PACK_SETTINGS_VALUES_REPOSITORY");
export const SETTINGS_SECRETS_REPOSITORY_TOKEN =
  createToken<SettingsSecretsRepository>(
    "CORE_PACK_SETTINGS_SECRETS_REPOSITORY",
  );
export const SETTINGS_SECRETS_CRYPTO_SERVICE_TOKEN =
  createToken<SettingsSecretsCryptoService>(
    "CORE_PACK_SETTINGS_SECRETS_CRYPTO_SERVICE",
  );
export const SETTINGS_PLUGIN_AUTH_KEY_PROVIDER_TOKEN =
  createToken<PluginAuthKeyProvider>(
    "CORE_PACK_SETTINGS_PLUGIN_AUTH_KEY_PROVIDER",
  );
export const SETTINGS_PLUGIN_AUTH_SERVICE_TOKEN =
  createToken<SettingsPluginAuthService>("CORE_PACK_SETTINGS_PLUGIN_AUTH_SERVICE");
export const SETTINGS_SERVICE_TOKEN =
  createCapabilityToken<SettingsService>("settings.service");
export const SETTINGS_ENTITY_REGISTRATION_TOKEN = createToken<boolean>(
  "CORE_PACK_SETTINGS_ENTITY_REGISTRATION",
);
export const SETTINGS_CONTROLLER_TOKEN =
  createToken<SettingsController>("CORE_PACK_SETTINGS_CONTROLLER");
