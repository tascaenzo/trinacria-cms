...
export const I18N_MESSAGES_REPOSITORY_TOKEN = createToken<I18nMessagesRepository>("I18N_MESSAGES_REPOSITORY");
export const I18N_MESSAGES_SERVICE_TOKEN = createToken<I18nMessagesService>("I18N_MESSAGES_SERVICE");
